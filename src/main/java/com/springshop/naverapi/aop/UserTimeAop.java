package com.springshop.naverapi.aop;

import com.springshop.naverapi.models.User;
import com.springshop.naverapi.models.UserTime;
import com.springshop.naverapi.repository.UserTimeRepository;
...
public class UserTimeAop {
    ...
    //point cut
    @Around("execution(public * com.springshop.naverapi.controller..*(..))")
